      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <h3 className="text-2xl font-bold">Hospital San José</h3>
            </div>
            <p className="text-gray-300 mb-4 leading-relaxed">
              Brindando atención médica de calidad desde 1985. 
              Nuestro compromiso es cuidar tu salud y la de tu familia con excelencia y calidez humana.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li><a href="#" className="hover:text-white transition-colors">Emergencias</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Consultas</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Laboratorio</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Hospitalización</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Cirugía</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-300">
              ...
              <p>📞 +1 (555) 123-4567</p>
              <p>📧 contacto@hospitalsanjose.com</p>
              <p>🚨 Emergencias: 911</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            &copy; 2025 Hospital San José. Todos los derechos reservados.
          </p>
